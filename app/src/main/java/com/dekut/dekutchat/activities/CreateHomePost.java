...
public class CreateHomePost extends AppCompatActivity {
    ImageButton btnCancel, btnCamera, btnGallery, btnCamcorder, btnPlay;
    Button btnPost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_home_post);
        ...
        btnGallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(CreateHomePost.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_DENIED){
                    ActivityCompat.requestPermissions(CreateHomePost.this, new String[] {Manifest.permission.READ_EXTERNAL_STORAGE}, READ_STORAGE1);
                }
                else {
                    selectMedia("gallery");
                }
        ...
        btnCamcorder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(CreateHomePost.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_DENIED){
                    ActivityCompat.requestPermissions(CreateHomePost.this, new String[] {Manifest.permission.CAMERA}, ACCESS_CAMERA2);
                }
                else {
            ...
            public void onClick(View v) {
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (view == null) {
                            view = new View(CreateHomePost.this);
                        }
                ...
                if (postText.isEmpty() && imageView.getDrawable() == null) {
                    ...
                    progressDialog = new ProgressDialog(CreateHomePost.this);
                    progressDialog.show();
                    ...
                    if (selectedImage != null && videoUri == null) {
                        try {
                            bitmap = MediaStore.Images.Media.getBitmap(CreateHomePost.this.getContentResolver(), selectedImage);
                    ...
                    if (bytes != null) {
                        StorageReference ref = firebaseStorage.getReference().child("homePics/" + UUID.randomUUID().toString());
                    ...
                    if (videoUri != null) {
                        try {
                            StorageReference ref = firebaseStorage.getReference().child("homeVideos/" + UUID.randomUUID().toString());
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == ACCESS_CAMERA1){
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                if(ContextCompat.checkSelfPermission(CreateHomePost.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    ...
                    if (intent.resolveActivity(getPackageManager()) != null) {
                        ...
                        if (photoFile != null) {
                            Uri photoURI = FileProvider.getUriForFile(CreateHomePost.this, "com.example.android.fileprovider", photoFile);
                    ...
                    ActivityCompat.requestPermissions(CreateHomePost.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_STORAGE);
                }
            }
            else {
            ...
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                if(ContextCompat.checkSelfPermission(CreateHomePost.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_GRANTED){
                    Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                    if (intent.resolveActivity(getPackageManager()) != null) {
                        File photoFile = null;
    ...
    public void selectMedia(String source){
        ...
        if (source.equals("camera")) {
            if (ContextCompat.checkSelfPermission(CreateHomePost.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                ...
                ActivityCompat.requestPermissions(CreateHomePost.this, new String[]{Manifest.permission.CAMERA}, ACCESS_CAMERA1);
            }
        }
    ...
    public void uploadData() {
        ...
        DatabaseReference reference = firebaseDatabase.getReference().child("homePosts");
